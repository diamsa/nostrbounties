      ...
      {currentPage === "root" ? (
        <div className="overflow-x-scroll flex no-scrollbar mx-5 mt-4 sm:mx-0">
          ...
          <button
            ...
            className="py-1.5 px-4 mr-2 mb-2 text-xs font-medium text-dark-text rounded-full border border-gray-200 hover:bg-gray-100 dark:focus:ring-gray-700 dark:bg-sidebar-bg dark:text-gray-2 dark:border-blue-1"
          >
            Design
          </button>
          <button
      ...
      {currentPage === "writing" ? (
        <div className="overflow-x-scroll flex no-scrollbar mx-5 mt-4 sm:mx-0">
          ...
          <button
            type="button"
            onClick={() => navigate("/tag/writing")}
            className="py-1.5 px-4 mr-2 mb-2 text-xs font-medium text-dark-text whitespace-nowrap bg-gray-1 rounded-full border border-gray-200 hover:bg-gray-100 dark:focus:ring-gray-700 dark:bg-background-dark-mode dark:text-gray-2 dark:border-blue-1"
          >
            Writing and translation
          </button>
          <button
