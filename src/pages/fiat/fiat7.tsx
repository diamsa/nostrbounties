...
function CreateBounty() {
  ...
  let [title, setTitle] = useState<string>("Implement threaded comments in NoComment widget");
  let [content, setContent] = useState<string>("Modify https://github.com/fiatjaf/nocomment to allow comments to be sent in reply to other comments.");
