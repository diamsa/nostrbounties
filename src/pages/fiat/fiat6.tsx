...
function CreateBounty() {
  ...
  let [title, setTitle] = useState<string>("Port LiteWrite to NIP-78");
  let [content, setContent] = useState<string>("https://litewrite.net/ is a very simple and clean note-taking / writing app. It currently uses remoteStorage to save the data. Would be nice if it could use Nostr relays instead. Probably encrypting the content.");
